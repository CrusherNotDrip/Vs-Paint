...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat(Paths.font("Marker.ttf"), 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("Marker.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("Marker.ttf");
