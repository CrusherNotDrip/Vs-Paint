...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Ad 1', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 2', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 3', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 4', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 5', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 6', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 7', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 8', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 9', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 10', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."],
		['Ad 11', "Places a fake ad,\nValue 1: Ad to be placed (Located in images/ads/)\nValue 2: How long it takes to disappear."]
	];
	...
	**/
	...
	override function create()
	{
		...
		for (i in 0...tipTextArray.length) {
			...
			tipText.y += i * 12;
			tipText.setFormat(Paths.font("Marker.ttf"), 14, FlxColor.WHITE, LEFT/*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
	...
	function updateGrid():Void
	{
		...
		for (i in _song.notes[curSec].sectionNotes)
		{
			...
			if(i[3] != null && note.noteType != null && note.noteType.length > 0) {
				...
				daText.setFormat(Paths.font("Marker.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
				daText.xAdd = -32;
				daText.yAdd = 6;
				daText.borderSize = 1;
		...
		for (i in _song.events)
		{
			if(endThing > i[0] && i[0] >= startThing)
			{
				...
				daText.setFormat(Paths.font("Marker.ttf"), 12, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
				daText.xAdd = -410;
				daText.borderSize = 1;
