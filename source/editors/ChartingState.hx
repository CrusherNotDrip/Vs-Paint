...
class ChartingState extends MusicBeatState
{
	...
	*/
	function waveformData(buffer:AudioBuffer, bytes:Bytes, time:Float, endTime:Float, multiply:Float = 1,
		?array:Array<Array<Array<Float>>>, ?steps:Float)#if desktop :Array<Array<Array<Float>>> #end //fucking html5 build doesnt compile with this line and windows doesnt compile without this line
	{
		#if (lime_cffi && !macro)
